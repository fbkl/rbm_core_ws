...
from insoles_fb_flexbe_states.env_vars_userdata_setter import UrdfEnvUserDataSetterState
...
@author: fbk
'''
class insoles_simple_scalingSM(Behavior):
	'''
	...
	def __init__(self):
		super(insoles_simple_scalingSM, self).__init__()
		self.name = 'insoles_simple_scaling'

		# parameters of this behavior
		self.add_parameter('model_flexbe_package', 'insoles_fb_flexbe_behaviors')
	...
	def create(self):
		...
		_state_machine = OperatableStateMachine(outcomes=['finished', 'failed'], input_keys=['insole_length', 'foot_left_name', 'foot_right_name'])
